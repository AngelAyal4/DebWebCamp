<aside class="dashboard__sidebar">
    <nav class="dashboard__menu">
        <a href="/admin/dashboard" class="dashboard__enlace">
            ...
            <span class="dashboard__menu__texto">Inicio</span>
        </a>

        <a href="/admin/ponentes" class="dashboard__enlace">
            <i class="fa-solid fa-microphone dashboard__icono"></i>
            <span class="dashboard__menu__texto">Ponentes</span>
        </a>

        <a href="/admin/eventos" class="dashboard__enlace">
            <i class="fa-solid fa-calendar dashboard__icono"></i>
            <span class="dashboard__menu__texto">Eventos</span>
        </a>

        <a href="/admin/resgistrados" class="dashboard__enlace">
            <i class="fa-solid fa-users dashboard__icono"></i>
            <span class="dashboard__menu__texto">Resgistrados</span>
        </a>

        <a href="/admin/regalos" class="dashboard__enlace">
            <i class="fa-solid fa-gift dashboard__icono"></i>
            <span class="dashboard__menu__texto">Regalos</span>
        </a>
