<header class="header">
    <div class="header__contenedor">
        <nav class="header__navegacion">
            <?php if(is_auth()) { ?>
                <a href="<?php echo is_admin() ? '/admin/dashboard' : '/finalizar-registro'; ?>" class="header__enlace">Perfil</a>
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto header__texo--modalidad">En Linea - Presencial</p>
